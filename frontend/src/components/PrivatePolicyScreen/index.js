...
const PrivacyPolicy = () => {
    return (
        ...
        <h2 className='wd-black wd-center'>Privacy Policy</h2>
            <hr/>
            <div className="container">
                <div className="col">
                    Recipee, LLC ("we”, “us”, or “our") provides this Privacy Policy to inform you of our policies and procedures regarding the collection, use and disclosure of personal information we may receive from users of our website (“Site”) and any other services offered by us in connection with our site (any and all of the foregoing the "Services").
                    <h5 className='wd-black mt-4 mb-4'>
